  ...
  return (
    <View
      ...
      <View style={styles.headerContainer}>
        <View style={styles.imageContainer}>
          <CustomImage
            ...
            source={
              type == 'basic'
                ? require('../Assets/Images/basicman.jpg')
                : require('../Assets/Images/premiumman.jpg')
            }
            style={{
              alignSelf: 'center',
              width: '100%',
      ...
      <CustomButton
        ...
        isBold
        textColor={type == 'basic' ? Color.white : Color.green}
        width={windowWidth * 0.75}
        height={windowHeight * 0.06}
        marginTop={moderateScale(20, 0.3)}
        onPress={onPress}
        bgColor={type == 'basic' ? Color.green : Color.white}
